...
<html lang="en">
  ...
  <body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
      ...
      <div
        ...
        <img class="animation__shake" src="/dist/img/AdminLTELogo.png"
          alt="FlickMasters" height="60" width="60">
      </div>
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="/admin" class="brand-link">
          <img src="/dist/img/AdminLTELogo.png" alt="FlickMasters"
    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <h1 class="text-center">Liste de stands</h1>
            <hr>
            <div class="d-flex justify-content-center">
                <a href="{{ route('stands.create') }}" class="btn btn-info">Ajouter un stand</a>
            </div>
            <hr>
            @if (session("status"))
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Tarif de location</th>
                ...
                <tbody>
                    @foreach ($stands as $stand)
                        <tr class="stand-row">
                            <td class="text-center">{{ $stand->numero }}</td>
                            <td class="text-center">{{ $stand->emplacement }}</td>
                            <td class="text-center">{{ $stand->tarif_de_location }}</td>
                            <td class="text-center">{{ $stand->status }}</td>
                            <td class="text-center">{{ $stand->event->name }}</td>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="{{ route('stands.edit', ['stand' => $stand]) }}" class="btn btn-primary" style="margin-right: 5px">Modifier</a>
                                    <form method="post" action="{{ route('stands.destroy', ['stand' => $stand]) }}">
                                        @csrf
                                        @method("delete")
