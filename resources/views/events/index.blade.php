                ...
                <div class="row justify-content-center">
                  <div class="col-md-9">
                    ...
                    <div class="d-flex justify-content-center">
                      <a href="{{ route('events.create') }}" class="btn btn-info">Ajouter un événement</a>
                    </div>
                    <hr>
                    @if (session("status"))
                    ...
                    <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center">Prix d'entrée</th>
                      ...
                      <tbody>
                        ...
                        <tr class="article-row">
                          ...
                          <td class="text-center">{{ $event->entry_price }}</td>
                          <td class="text-center">
                            <div class="btn-group">
                                <a href="{{ route('events.edit', ['event' => $event]) }}" class="btn btn-primary" style="margin-right: 5px">Modifier</a>
