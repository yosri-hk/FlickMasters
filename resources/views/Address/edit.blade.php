...
<section class="content">
        ...
        <div id="editProductContent">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9">
                        <h1 class="text-center">Update adress</h1>
                        <hr>
                        ...
                        <form action="{{ route('Address.update', ['adresse' => $adresse]) }}" method="POST">
    @csrf
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="Deliveryaddresse" name="Deliveryaddresse" value="{{ $adresse->Deliveryaddresse }}" required>
    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="City" name="City" value="{{ $adresse->City }}" required>
                            </div>

                            <div class="mb-3">
                                <label for="Postal_code" class="form-label">Postal_code</label>
                                <input type="number" class="form-control" id="Postal_code" name="Postal_code" value="{{ $adresse->Postal_code }}">
                            </div>
