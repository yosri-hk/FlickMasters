            ...
            <div class="row">
              ...
              <div class="container">
                <div class="row justify-content-center">
                  <div class="col-md-9">
                    <h1 class="text-center">Liste des participations</h1>
                    <hr>
                    <hr>
                    @if (session("status"))
                    ...
                    <table class="table">
                      <thead>
                        <tr>
                          <th class="text-center">Au nom de</th>
                      ...
                      <tbody>
                        ...
                        <tr class="article-row">
                          <td class="text-center">{{ $participation->nom_participant }}</td>
                          <td class="text-center">
                            {{ $participation->cin_participant }}
                          </td>
